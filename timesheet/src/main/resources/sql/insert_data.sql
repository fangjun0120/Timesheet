...
INSERT INTO `USER` (`USER_ID`, `CREATED_AT`, `EMAIL`, `ENABLE`, `EXPIRED`, `FIRST_NAME`, `LAST_NAME`, `ORGANIZATION`, `PASSWORD`, `ROLE`, `USERNAME`) VALUES ('2', '2015-10-01', 'emp1@gmail.com', 'Y', 'N', 'X', 'Y', 'CollegeBoard', 'emp1', 'ROLE_EMPLOYEE', 'emp1');
INSERT INTO `USER` (`USER_ID`, `CREATED_AT`, `EMAIL`, `ENABLE`, `EXPIRED`, `FIRST_NAME`, `LAST_NAME`, `ORGANIZATION`, `PASSWORD`, `ROLE`, `USERNAME`) VALUES ('3', '2015-11-01', 'emp2@gmail.com', 'Y', 'N', 'S', 'K', 'CollegeBoard', 'emp2', 'ROLE_EMPLOYEE', 'emp2');
